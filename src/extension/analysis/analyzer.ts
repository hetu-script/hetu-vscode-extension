...
export function getAnalyzerArgs(logger: Logger, sdks: DartSdks, dartCapabilities: HetuCapabilities, isLsp: boolean) {
...
function buildAnalyzerArgs(analyzerPath: string, dartCapabilities: HetuCapabilities, isLsp: boolean) {
	let analyzerArgs = [];
